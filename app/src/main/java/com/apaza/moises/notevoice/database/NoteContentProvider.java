...
<application> element:
    ...
    <provider
            android:name="com.apaza.moises.notevoice.database.NoteContentProvider"
    ...
    */
    ...
    private static final String TABLENAME = NoteDao.TABLENAME;
    private static final String PK = NoteDao.Properties.Id
    .columnName;

    private static final int NOTE_DIR = 0;
    ...
    sURIMatcher.addURI(AUTHORITY, BASE_PATH, NOTE_DIR);
