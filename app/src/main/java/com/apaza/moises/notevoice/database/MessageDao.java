...
public class MessageDao extends AbstractDao<Message, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property TextMessage = new Property(2, String.class, "textMessage", false, "TEXT_MESSAGE");
        public final static Property CreateAt = new Property(3, java.util.Date.class, "createAt", false, "CREATE_AT");
        public final static Property IdNote = new Property(4, Long.class, "idNote", false, "ID_NOTE");
    };

    private DaoSession daoSession;

    private Query<Message> note_NoteMessageQuery;
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MESSAGE\" (" + //
                ...
                "\"CODE\" TEXT," + // 1: code
                "\"TEXT_MESSAGE\" TEXT," + // 2: textMessage
                "\"CREATE_AT\" INTEGER," + // 3: createAt
                "\"ID_NOTE\" INTEGER);"); // 4: idNote
    }
    ...
    public Message readEntity(Cursor cursor, int offset) {
        Message entity = new Message( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // textMessage
            cursor.isNull(offset + 3) ? null : new java.util.Date(cursor.getLong(offset + 3)), // createAt
            cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4) // idNote
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Message entity, int offset) {
        ...
        entity.setTextMessage(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setCreateAt(cursor.isNull(offset + 3) ? null : new java.util.Date(cursor.getLong(offset + 3)));
        entity.setIdNote(cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4));
     }
    ...
    /** Internal query to resolve the "NoteMessage" to-many relationship of Note. */
    public List<Message> _queryNote_NoteMessage(Long idNote) {
        synchronized (this) {
            if (note_NoteMessageQuery == null) {
                ...
                note_NoteMessageQuery = queryBuilder.build();
            }
        }
        Query<Message> query = note_NoteMessageQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN MESSAGE T0 ON T.\"ID_NOTE\"=T0.\"_id\"");
            builder.append(' ');
