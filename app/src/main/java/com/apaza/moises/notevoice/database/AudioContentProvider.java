...
<application> element:
    ...
    <provider
            android:name="com.apaza.moises.notevoice.database.AudioContentProvider"
            android:authorities="com.apaza.moises.notevoice.database.provider"/>
    */

    public class AudioContentProvider extends ContentProvider {

    public static final String AUTHORITY = "com.apaza.moises.notevoice.database.provider";
    ...
    private static final String TABLENAME = AudioDao.TABLENAME;
    private static final String PK = AudioDao.Properties.Id
    .columnName;

    private static final int AUDIO_DIR = 0;
    ...
    sURIMatcher.addURI(AUTHORITY, BASE_PATH, AUDIO_DIR);
    sURIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", AUDIO_ID);
    }
