...
<application> element:
    ...
    <provider
            android:name="com.apaza.moises.notevoice.database.AlarmContentProvider"
    ...
    */
    ...
    private static final String TABLENAME = AlarmDao.TABLENAME;
    private static final String PK = AlarmDao.Properties.Id
    .columnName;

    private static final int ALARM_DIR = 0;
    ...
    sURIMatcher.addURI(AUTHORITY, BASE_PATH, ALARM_DIR);
