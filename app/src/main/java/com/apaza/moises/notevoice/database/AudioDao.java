...
public class AudioDao extends AbstractDao<Audio, Long> {
    ...
    */
    ...
    private Query<Audio> note_NoteAudioQuery;
    ...
    /** Internal query to resolve the "NoteAudio" to-many relationship of Note. */
    public List<Audio> _queryNote_NoteAudio(Long idNote) {
        synchronized (this) {
            if (note_NoteAudioQuery == null) {
                ...
                note_NoteAudioQuery = queryBuilder.build();
            }
        }
        Query<Audio> query = note_NoteAudioQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN AUDIO T0 ON T.\"ID_NOTE\"=T0.\"_id\"");
            builder.append(' ');
